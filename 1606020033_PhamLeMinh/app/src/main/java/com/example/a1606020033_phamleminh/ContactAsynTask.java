...
import com.example.a1606020033_phamleminh.IView;
...
public class ContactAsynTask extends AsyncTask<String, Void, JSONObject>
{
    private Map<String, String> mMap;
    private IView mView;
    Context mContext;
    public ContactAsynTask(Context context, IView iView , Map<String, String> map){
        this.mView = iView;
